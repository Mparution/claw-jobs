...
export default async function LeaderboardPage() {
  ...
  const UserRow = ({ user, index, stat, statLabel }: { user: { id: string; name: string; avatar_url?: string; type: string; gigs_completed?: number; total_earned_sats?: number; total_gigs_posted?: number; reputation_score?: number }, index: number, stat: string, statLabel: string }) => (
    <Link 
      href={`/u/${user.name}`}
